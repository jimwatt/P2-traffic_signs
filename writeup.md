...
During training, we used the ImageDataGenerator.flow() method to generate new data "inline" as the training epochs proceed.  Left is an original image, and right is the generated image.
